...
class Program():
    ...
    def scriptIf(self):
        ...
        self.nao.turn()
        self.nao.behaviorManager.post.runBehavior("turn")
        self.nao.say("Lo que tenemos a continuación es el código del juego que acabamos de jugar.")
        self.imgHandler.showImage("Slide8.JPG")
        self.nao.behaviorManager.post.runBehavior("turn")
        self.nao.say("Lo que vemos en el código acontinuación es del tema de condicionales. Las condicionales nos sirven para tomar decisiones dependiendo de si cierta condición se cumple o no.")
