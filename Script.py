...
class Program():
    ...
    def scriptIf(self):
        ...
        self.nao.textAnimatedToSpeech.say("Ya que cinco es menor a diéz, la respuesta ahora sería ahora negativa y por lo tanto")
        self.imgHandler.showImage("Slide15.JPG")
        self.nao.textAnimatedToSpeech.say("habrá que ejecutar la acción de buscar más dinero.") 
        self.imgHandler.showImage("Slide16.JPG")
        self.nao.textAnimatedToSpeech.say("Ahora les enseñaré cómo quedaría el código de ésta condicional.") 
        self.imgHandler.showImage("Slide17.JPG")
        self.nao.textAnimatedToSpeech.say("En la presentación pueden ver el pedazo de código que representaría la pequeña ruta de decisiones de lo que explicamos anteriormente. Qué les parece? sencillo?")
        self.imgHandler.showImage("Slide18.JPG")
        self.nao.textAnimatedToSpeech.say("Ahora volvámos al código que usamos cuando jugué con " + seletedstudent + ". Vemos aquí como se hacen también diferentes preguntas para saber que es lo que debe hacerse dependiendo de las condiciones.")
        ...
        self.imgHandler.showImage("Slide39.JPG")
        ...
        self.imgHandler.showImage("Slide40.JPG")
